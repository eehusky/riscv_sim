module tb_dport ();
    ...
    dport i_dport (
        .rst_i                 (rst_i),
        .clk_i                 (clk_i),
        .dport_accept_o        (mem_accept_o),
        .dport_ack_o           (mem_ack_o),
        .dport_data_rd_o       (mem_data_rd_o),
        .dport_addr_i          (mem_addr_i),
        .dport_data_wr_i       (mem_data_wr_i),
        .dport_error_o         (mem_error_o),
        .dport_rd_i            (mem_rd_i),
        .dport_wr_i            (mem_wr_i),
        .dport_req_tag_i       (mem_req_tag_i),
        .dport_resp_tag_o      (mem_resp_tag_o),
        .dport_cacheable_i     (mem_cacheable_i),
        .dport_invalidate_i    (mem_invalidate_i),
        .dport_writeback_i     (mem_writeback_i),
        .dport_flush_i         (mem_flush_i),
