...
module dm_obi_top #(
  parameter int unsigned        MIdWidth          = 1,      // Width of aid/rid
  parameter int unsigned        SIdWidth          = 1,      // Width of aid/rid
  ...
  input  logic [SIdWidth-1:0]    slave_aid_i,
  ...
  output logic [SIdWidth-1:0]    slave_rid_o,
  ...
  logic [SIdWidth-1:0] slave_rid_q;
