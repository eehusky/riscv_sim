...
#include "Vtb_rsd_top.h"
#include "Vtb_rsd_top__Syms.h"
...
public:
    ...
    void write(uint32_t addr, uint8_t data)
    {
        ...
        m_dut->tb_rsd_top->vlSymsp->TOP__tb_rsd_top.write(addr, data);
    ...
    {
        addr = addr-MEM_BASE;
        return m_dut->tb_rsd_top->vlSymsp->TOP__tb_rsd_top.read(addr);
    }
    void dump()
    {
...
int main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vtb_rsd_top> top{new Vtb_rsd_top{contextp.get(), "TOP"}};
