...
void riscv_mtvec_instruction_address_misaligned(void) __attribute__((weak));
void riscv_mtvec_instruction_access_fault(void) __attribute__((weak));
void riscv_mtvec_illegal_instruction(void) __attribute__((weak));
void riscv_mtvec_breakpoint(void) __attribute__((weak));
void riscv_mtvec_load_address_misaligned(void) __attribute__((weak));
void riscv_mtvec_load_access_fault(void) __attribute__((weak));
void riscv_mtvec_store_amo_address_misaligned(void) __attribute__((weak));
void riscv_mtvec_store_amo_access_fault(void) __attribute__((weak));
void riscv_mtvec_environment_call_from_u_mode(void) __attribute__((weak));
void riscv_mtvec_environment_call_from_s_mode(void) __attribute__((weak));
void riscv_mtvec_environment_call_from_m_mode(void) __attribute__((weak));
void riscv_mtvec_instruction_page_fault(void) __attribute__((weak));
void riscv_mtvec_load_page_fault(void) __attribute__((weak));
void riscv_mtvec_store_amo_page_fault(void) __attribute__((weak));
...
//        interrupt_handlers[mcause & MCAUSE_INT_CAUSE]();
//    } else {
//        // synchronous exception, branch to handler
//        exception_handlers[mcause & MCAUSE_EXCP_CAUSE]();
//    }
//}
