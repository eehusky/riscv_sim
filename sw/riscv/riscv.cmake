...
#     set( RISCV_GCC_COMPILER ${RISCV_GITHUB_GCC_COMPILER_EXE})
     ...
     message(
          FATAL_ERROR
          "RISC-V GCC not found. ${RISCV_GITHUB_GCC_COMPILER} ${RISCV_XPACK_GCC_COMPILER} ${RISCV_GITHUB_GCC_COMPILER_EXE} ${RISCV_XPACK_GCC_COMPILER_EXE}"
     )
endif()
...
#set( CMAKE_SYSTEM_PROCESSOR     rv32im_zicsr_zifencei_zbb )
...
set( CMAKE_SIZE      ${RISCV_TOOLCHAIN_BIN_PATH}/${CROSS_COMPILE}size
...
#set( CMAKE_EXE_LINKER_FLAGS   "${CMAKE_EXE_LINKER_FLAGS} -b elf32-littleriscv -A rv32im -march=${CMAKE_SYSTEM_PROCESSOR} -mabi=${CMAKE_SYSTEM_ABI}    -nostartfiles   " )
#set( CMAKE_EXE_LINKER_FLAGS   "${CMAKE_EXE_LINKER_FLAGS} -Wl,-b elf32-littleriscv -Wl,-A rv32im" )
