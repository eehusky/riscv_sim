 ...
 */
void riscv_mtvec_exception(void) __attribute__((interrupt("machine"), aligned(4)));

/** Machine mode software interrupt */
void riscv_mtvec_msi(void) __attribute__((interrupt("machine"), aligned(4)));
/** Machine mode timer interrupt */
void riscv_mtvec_mti(void) __attribute__((interrupt("machine"), aligned(4)));
/** Machine mode al interrupt */
void riscv_mtvec_mei(void) __attribute__((interrupt("machine"), aligned(4)));

/** Supervisor mode software interrupt */
void riscv_mtvec_ssi(void) __attribute__((interrupt("machine"), aligned(4)));
/** Supervisor mode timer interrupt */
void riscv_mtvec_sti(void) __attribute__((interrupt("machine"), aligned(4)));
/** Supervisor mode al interrupt */
void riscv_mtvec_sei(void) __attribute__((interrupt("machine"), aligned(4)));

/** Supervisor mode syncronous exception handler. */
void riscv_stvec_exception(void) __attribute__((interrupt("supervisor"), aligned(4)));

/** Supervisor mode software interrupt */
void riscv_stvec_ssi(void) __attribute__((interrupt("supervisor"), aligned(4)));
/** Supervisor mode timer interrupt */
void riscv_stvec_sti(void) __attribute__((interrupt("supervisor"), aligned(4)));
/** Supervisor mode al interrupt */
void riscv_stvec_sei(void) __attribute__((interrupt("supervisor"), aligned(4)));

/** User mode software interrupt */
void riscv_utvec_usi(void) __attribute__((interrupt("user"), aligned(4)));
/** User mode timer interrupt */
void riscv_utvec_uti(void) __attribute__((interrupt("user"), aligned(4)));
/** User mode al interrupt */
void riscv_utvec_uei(void) __attribute__((interrupt("user"), aligned(4)));
